...
@property(nonatomic,retain)CustomTabVC *tabBarController;
@end
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    _tabBarController=[CustomTabVC new];
    [self.tabBarController.tabBar setShadowImage:[UIImage imageNamed:@"tm"]];
